...
namespace AlgoTerminal_Base.FileManager
{
    public class StraddleDataBaseLoadFromCsv : IStraddleDataBaseLoadFromCsv
    {
        ...
        public StraddleDataBaseLoadFromCsv(IStraddleManager straddleManager, ILogFileWriter logWriter)
        {
            ...
            try
            {
                ...
                while ((line = _reader.ReadLine()) != null)
                {
                    ...
                    else
                    {
                        ...
                        {
                            var Leg_Dic = _straddleManager.Straddle_LegDetails_Dictionary[_PreviousKey];
