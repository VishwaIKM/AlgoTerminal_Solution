namespace AlgoTerminal.Model.Structure
{
    public sealed class EnumDeclaration
    {
        ...
        public enum EnumStrategyMessage {LEG_TP_HIT,LEG_SL_HIT,OVERALL_TP_HIT,OVERALL_SL_HIT,INVALID_TIME,ERROR,ORDER_CANCELLED_BY_SYSTEM,ORB_IN_PROGRESS,MOMENTUM,NONE,MANUAL_SQUAREOFF,RE_ENTRY};
